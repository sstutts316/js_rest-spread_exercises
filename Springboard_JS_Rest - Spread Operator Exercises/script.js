...
// Refactor the code block above to use the rest operator & an arrow function:
const filterOutOdds = (...nums) => nums.filter(num => num % 2 === 0);

console.log(filterOutOdds(9,10,11,12,13,14,15,16));

// Write a function called findMin that accepts a variable number of arguments and returns the smallest argument.
//two ways to refactor in 1 line: 
//1. const findMin = (...args) => args.length === 0 ? undefined : Math.min(...args);
